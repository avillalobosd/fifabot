...
def clickEncontrado():
    if len(driver.find_elements_by_xpath("/html/body/main/section/section/div[2]/div/div/section[1]/div/ul/li/div")) > 0:
        ...
        tablaLog.insert(parent="",index="end",text="parent",values=("ENCONTRADO POR "+ driver.find_element_by_xpath("/html/body/main/section/section/div[2]/div/div/section[1]/div/ul/li/div/div[2]/div[3]/span[2]").text) )
        comprar()
    # else:
...
def comprar():
    ...
    if len(driver.find_elements_by_xpath("/html/body/div[4]/section/div/div/button[1]")) > 0:
        ...
        if float(driver.find_element_by_xpath("/html/body/main/section/section/div[1]/div[1]/div[1]").text) != float(saldoInicial):
            print("SE COMPRO")
            tablaLog.insert(parent="",index="end",text="parent",values=("SE COMPRO") )
            ...
            tablaLog.insert(parent="",index="end",text="parent",values=("NO SE COMPRO") )
            print("NO SE COMPRO")
        time.sleep(5)
    else:
        print("FALSA ALARMA")
...
def stop():
    ...
    print("STOP")
    # tablaLog.insert(parent="",index="end",text="parent",values=("Detener") )
    global seguir
    seguir = False

## INICIAR A BUSCAR Y COMPRAR
def iniciar():
    tablaLog.insert(parent="",index="end",text="parent",values=("ENCENDIDO") )
    ...
    gminima=str(float(precioFinal)*.95-int(maximo.get()))
    # tablaLog.insert(parent="",index="end",text="parent",values=(gminima) )
...
tablaLog.insert(parent="",index="end",text="parent",values=("OK") )
